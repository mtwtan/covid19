...
############################
# This script is meant for data starting from 03/22/2020
# Which uses the new schema that includes columns like FIPS and admin2
#
# Modify the start and end dates as necessary -- see s_date and e_date right after the functions code
# Make sure that s_date is >= 03/22/2020
############################


bucket = "<S3 Bucket Name>" #### Enter your S3 bucket name
rootkey = "covid-19/jhu/daily_new/" #### Modify as necessary for the key in your S3 bucket. Remember to ADD trailing slash /
baseurl = "https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_daily_reports/"
jhu_folder = "/tmp/jhu_new/"
...
e_date = "04-02-2020" ### Modify as necessary
